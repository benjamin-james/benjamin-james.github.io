...
\vspace{1mm}
\small{
	Computational biologist and engineer (MIT EECS Ph.D., 2026) - two co-first-author Cell papers, contributor to Terminal-Bench Science.
	Building scalable numerical infrastructure and agent-evaluation tooling that lets computational biology meet AI at the scale real datasets demand in service of concrete biological discoveries.
...
\item  Led computational analysis on a cross-species striatum atlas (670K nuclei, 69 human donors) defining rare subpopulations including molecular subtypes of the century-old islands of Calleja, a notable species-conserved dorsolateral–ventromedial gradient, and human-enriched druggable targets invisible to rodent models, notably CHRM5 (a Cobenfy/xanomeline receptor) and GLP-1R/GIPR sites with CNS mechanistic implications for obesity and addiction therapeutics.
%% Led computational analysis on a cross-species striatum atlas (~670K nuclei, 69 donors) that molecularly resolved the century-old striatal islands (Islands of Calleja, 1882) into defined subtypes, mapped a dorsolateral-ventromedial transcriptional gradient across the region, and surfaced species-divergent druggable targets invisible to rodent models including human-enriched CHRM5 (relevant to FDA-approved Cobenfy/xanomeline) and striatal GLP-1R expression with implications for CNS mechanisms of GLP-1 agonists.
...
{Contributor (under review) to \textbf{terminal-bench-science} \href{https://github.com/benjamin-james/terminal-bench-science/}{\faGithub},\href{https://github.com/harbor-framework/terminal-bench-science/discussions/301}{\faGithub} - benchmark for AI agents on scientific workflows; parent benchmark is featured on frontier model cards,
...
\resumeProject
{Cronin Fellowship}% / MIT EECS department}
{MIT EECS department}
{Awarded April 2019}
{{}}
%% \resumeItemListStart
